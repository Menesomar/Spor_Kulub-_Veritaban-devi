...
# --- ATHLETIC PERFORMANCE (AYDINLIK & ENERJİK KOŞU) CSS ---
st.markdown("""
<style>
    /* Spor estetiği için Montserrat ve Kronometre sayıları için Roboto Mono */
    ...
    /* Genel Tipografi ve Temiz Arka Plan */
    html, body, [class*="css"] {
        font-family: 'Montserrat', sans-serif;
        color: #111111; /* Karbon Siyahı */
    }
    
    .stApp {
        background-color: #F4F6F8; /* Temiz Pist Grisi */
    }
    ...
    /* --- YAN MENÜ (ANTRENMAN EKRANI HİSSİYATI) --- */
    ...
    div[role="radiogroup"] > label {
        ...
        border-radius: 4px !important; /* Daha keskin sportif hatlar */
    ...
    div[role="radiogroup"] > label[data-checked="true"] {
        ...
        border-left: 6px solid #FF4B00 !important; /* Enerjik Turuncu Vurgu */
    ...
    .stButton>button {
        ...
        font-style: italic; /* Hız hissiyatı */
    }
    ...
    /* --- GİRİŞ ALANLARI VE FORMLAR (NET VE TEMİZ) --- */
    ...
    /* --- METRİK KARTLARI (KRONOMETRE EKRANI) --- */
    div[data-testid="metric-container"] {
        background-color: #FFFFFF;
        border: 2px solid #E5E7EB;
        border-left: 6px solid #FF4B00; /* Turuncu Pist Çizgisi */
        border-radius: 6px;
        padding: 20px;
    ...
    /* Sayılar Kronometre Fontu İle Yazılır */
    ...
    /* Tablo Görünümü %100 Uyum İçin Sıfırlandı */
...
if not st.session_state.giris_yapildi:
    ...
    with col2:
        ...
        <div style='background-color: #FFFFFF; padding: 40px 30px; border-radius: 8px; border: 2px solid #E5E7EB; border-top: 8px solid #FF4B00; box-shadow: 0 10px 25px rgba(0,0,0,0.05); text-align: center;'>
            <h1 style='color: #111111; font-weight: 900; font-style: italic; letter-spacing: -2px; text-transform: uppercase; margin-bottom: 5px; font-size: 2.8rem;'>🏃‍♂️ KOŞU KULÜBÜ</h1>
            <h4 style='color: #6B7280; font-weight: 700; letter-spacing: 4px; margin-top: 0px; margin-bottom: 25px; text-transform: uppercase; font-size: 0.9rem;'>Performans Yönetim Sistemi</h4>
    ...
    # --- ANA SİSTEM ---
    st.sidebar.markdown(f"<h3 style='color: #111111; font-weight: 900; font-style: italic; margin-bottom: 0; text-transform: uppercase;'>{st.session_state.kullanici_adi}</h3>", unsafe_allow_html=True)
    ...
    st.sidebar.markdown("<hr style='border-color: #E5E7EB; margin: 10px 0;'>", unsafe_allow_html=True)
    ...
    # --- 1. DUYURULAR PANOSU ---
    if secim == "📢 Duyurular":
        st.markdown("<h1 style='color: #111111; font-weight: 900; font-style: italic; text-transform: uppercase; letter-spacing: -1px;'>📢 Kulüp Panosu</h1>", unsafe_allow_html=True)
        st.markdown("<p style='color: #4B5563; font-weight: 500;'>Sistem genelindeki en son gelişmeler ve antrenman bildirimleri.</p><hr>", unsafe_allow_html=True)
        
        dash_col1, dash_col2, dash_col3 = st.columns(3)
        with dash_col1:
            st.info("🏃‍♂️ KULÜP HEDEFİ: 10.000 KM")
        with dash_col2:
    ...
    # --- 2. DUYURU YAYINLA (Sadece Admin) ---
        ...
        st.markdown("<p style='color: #4B5563; font-weight: 500;'>Tüm üyelerin görebileceği yeni bir bildirim oluşturun.</p><hr>", unsafe_allow_html=True)
    ...
    # --- 6. TÜM ÜYELER ---
        ...
        st.markdown("<h1 style='color: #111111; font-weight: 900; font-style: italic; text-transform: uppercase; letter-spacing: -1px;'>👥 Kulüp Sicili</h1>", unsafe_allow_html=True)
